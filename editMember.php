    ...
    <main>
        <form method="post" action="updateMEMBER.php" class="editMemberform">
            ...
            <div class="editFormInput">
                ...
                <input type="text" pattern="^\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01])$" name="dateofbirth"
                    id="dateofbirth" required placeholder="YYYY-MM-DD" />
            </div>
            ...
            <div class="buttonCancel">
                <button class="buttonCancel" id=button1 buttonType="secondary" type="reset"
