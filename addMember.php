  ...
  <main>
    <form method="post" action="processMEMBER.php" class="form">
      ...
      <div class="form-input">
        ...
        <input type="date" pattern="^\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01])$" id="date" name="date" required>
      </div>
      <div class="form-input">
      ...
      <div class="form-input">
        ...
        <input type="text" id="mnumber" name="mnumber" maxlength="10" pattern="[\d]{10}" placeholder="For eg. 0400000000">
      </div>
